...
@servers(['development' => ['tdi-dev2'],'stage' => [''],'production' => ['']])
...
$remote = 'git@github.com:nsmg-development/mq-cockoo.git';   // github repository to clone
$base_dir = "/home/tdi/mq-cockoo";        // document that holds projects
$project_name = "mq-cockoo";        // project name
